...
namespace VinylCollector.Controllers
{
    public class TracksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TrackID,Title,IsSingle,Length")] Track track)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TrackID,Title,IsSingle,Length")] Track track)
        {
            if (ModelState.IsValid)
            {
